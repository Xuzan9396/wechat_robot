...
SERVER_PORT = 12725  # websocket 监听的端口
SEC_TOKEN = 'xuzan2725'  # websocket连接需要在headers带上token： <Authorization: Bearer SEC_TOKEN>，为空则不验证
WS_PATH = '/'
...
class WebsocketServer:
    ...
    async def receive_ws_msg(self, websocket):
        ...
        :return: None
        """
        print(f'开始监听客户端：{websocket.remote_address}的消息')
    ...
    async def call_api(self, action):
        ...
        func = getattr(self.wx_bot, method_name)
        kwargs = {}
